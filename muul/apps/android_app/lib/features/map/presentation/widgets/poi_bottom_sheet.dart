...
class PoiBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final enItinerario =
        s?.poisParaItinerario.any((p) => p.id == poi.id) ?? false;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: temaColors.secondary.withValues(alpha: 0.3)),
      ),
      child: Column(
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      icon: Icon(
                          enItinerario ? Icons.remove : Icons.add,
                          size: 18),
                      label: Text(
                          enItinerario ? 'Quitar' : 'Itinerario'),
                      onPressed: () {
                        ref
                            .read(mapProvider.notifier)
...
class _PoiImage extends StatelessWidget {
  ...
  // Icono según categoría para el placeholder
  ...
  Widget build(BuildContext context) {
    ...
    // 2. Placeholder con icono de categoría
    return _placeholder();
  }
}