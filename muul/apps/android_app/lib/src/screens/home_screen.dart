...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final pages = [
      _HomeMock(status: _status, onCheckBackend: _checkBackend),
...
class _HomeMock extends StatelessWidget {
  const _HomeMock({required this.status, required this.onCheckBackend});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Usa la pestana Perfil para validar edicion de usuario y cierre de sesion.',
            ),
          ],
        ),
      ),
